...
daily_pay = hourly_pay * hour_worked
...
age_in_ten_years = int(user_age) + 10
...
first_user_number = input("PLease enter a whole number")
...
second_user_number = input("PLease enter a second whole number")
...
user_sum = int(first_user_number) + int(second_user_number)
user_difference = int(first_user_number) - int(second_user_number)
user_product = int(first_user_number) * int(second_user_number)
user_quotient = int(first_user_number) / int(second_user_number)
...
work_hours = input("how many hours do you wokr in a day?")
...
hourly_rate = input("how much money do you make each hour?")
...
one_day_pay = int(work_hours) * int(hourly_rate)
...
money_spent = input("How much money did you spend?")
money_after_spending = five_day_pay - int(money_spent)
...
total_student = 120
classrooms = 5
students_per_classroom = total_student / classrooms
...
age_message = ("you are approximatly" + age_as_string + "years old")
...
number1 = input("Give me one number")
number2 = input("Give me another number")
number3 = input("Give me one more number")
combined_total = int(number1) + int(number2) + int(number3)
...
favorite_number_times_age = favorite_number * final_approximate_age

print("Hello " + final_full_name + "!")
print("Your approximate age is", final_approximate_age)
print("Your favorite number multiplied by your age is ", favorite_number_times_age)
